...
The following functional modules were implemented (fifteen core modules, with five additional Islamic-specific modules marked with $\star$). Beyond these, the platform ships \emph{four flagship platforms}, each reframing the product into a category no incumbent occupies: \textbf{Family-First} guardian-led matchmaking (guardians browse/shortlist on behalf of a ward with family-to-family chat), \textbf{Tazkiya} earned-trust network (member + imam character endorsements producing a tiered trust score), the \textbf{Nikah Completion} platform (an end-to-end marriage-journey tracker with a kazi/counselor marketplace, mahr-agreement module and premarital course), and \textbf{Sukoon} (a dignity-first, extra-private channel for second marriages).
